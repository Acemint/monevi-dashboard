<template>
  <nav class="navbar navbar-light navbar-expand-md fixed-top py-3" ref="indexNavigator" id="mainNav">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="/"><img style="height: 30px" src="@/assets/img/logo-full.svg" /> </a>
    ...
    <div class="container pt-4 pt-xl-5">
      <div class="row pt-5">
        ...
        <div class="col-12 col-lg-10 mx-auto">
          <div class="text-center position-relative"><img class="img-fluid" src="@/assets/img/illustration/meeting.svg" style="width: 800px; padding: 50px" /></div>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container py-4 py-xl-5">
      ...
      <div class="row gy-4 gy-md-0">
            ...
            <div class="row gy-2 row-cols-1 row-cols-sm-2">
              <div class="col text-center text-md-start">
                <div class="d-flex justify-content-center align-items-center justify-content-md-start">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-sun fs-3 text-primary bg-warning">
        ...
        <div class="col-md-6 order-first order-md-last">
          <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px" src="@/assets/img/illustration/teamwork.svg" /></div>
        </div>
      </div>
    </div>
  </section>
