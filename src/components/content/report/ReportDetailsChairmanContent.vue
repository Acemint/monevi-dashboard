      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <p>Belum ada laporan yang dikirim kepadamu di bulan ini</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="card-footer text-right" v-if="reportSummary.reportStatus == 'UNAPPROVED'">
                <div>
...
<script lang="ts">
  ...
  export default {
    ...
    methods: {
      ...
      formatReportStatus(status: string, role: string = 'ROLE_CHAIRMAN'): string {
