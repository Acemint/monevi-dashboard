            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"><img src="./assets/img/logo-full.svg" style="height: 19px;"></a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html"><img src="./assets/img/logo.svg" style="height: 19px;"></a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Dashboard</li>
                        <li class="active"><a class="nav-link" href="index.html"><i class="fas fa-fire"></i>
                                <span>Dashboard</span></a></li>
                        <li class="menu-header">Starter</li>
                        <li><a class="nav-link" href="proker.html"><i class="fas fa-briefcase"></i>
                                <span>Program Kerja</span></a></li>
                        <li><a class="nav-link" href="transactions.html"><i class="fas fa-wallet"></i>
