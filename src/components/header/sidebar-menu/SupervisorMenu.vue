...
export default {
  ...
  data: function() {
    return {
      dashboardItems: [
        { name: 'Dashboard', path: '/dashboard', class: 'fas fa-fire', active: false},
        { name: 'Program Kerja', path: '/proker', class: 'fas fa-briefcase', active: false},
        { name: 'Laporan', path: '/transaction', class: 'fas fa-wallet', active: false}
      ]
    }
  },
