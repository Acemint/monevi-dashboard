<template>
  ...
  <div class="main-content">
    <DashboardTreasurerContent v-if="userAccount.role === 'ROLE_TREASURER'" />
    <DashboardChairmanContent v-else-if="userAccount.role === 'ROLE_CHAIRMAN'" />
    <DashboardSupervisorContent v-else-if="userAccount.role === 'ROLE_SUPERVISOR'" />
  </div>
  <MainFooter />
</template>
